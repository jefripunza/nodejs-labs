...
module.exports = __nccwpck_require__(1826);
...
var debug = __nccwpck_require__(8237)('morgan')
...
// import all routers
app.use((__nccwpck_require__(6109)["default"]));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.HargaSembako = void 0;
// Service
const ViewHargaSembako_1 = __importDefault(__nccwpck_require__(1699));
const HargaSembako = async (req, res) => {
    const { code, message, render } = await (0, ViewHargaSembako_1.default)();
    if (render) {
        return res.status(code).json(render);
    }
    return res.status(code).json({ message });
};
exports.HargaSembako = HargaSembako;
...
exports["default"] = async () => {
    const url = process.env.URL_SEMBAKO_MANAGEMENT_SERVICE;
...
const controller = __importStar(__nccwpck_require__(8577));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
// Fetcher
const getHargaSembako_1 = __importDefault(__nccwpck_require__(3454));
exports["default"] = async () => {
    try {
        const response = await (0, getHargaSembako_1.default)();
        return {
            code: 200,
            render: {
